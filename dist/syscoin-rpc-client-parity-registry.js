...
var SyscoinParityRegistry = function () {
    function SyscoinParityRegistry(syscoinClient) {
        (0, _classCallCheck3.default)(this, SyscoinParityRegistry);
    ...
    (0, _createClass3.default)(SyscoinParityRegistry, [{
    ...
    return SyscoinParityRegistry;
}();

exports.default = SyscoinParityRegistry;