import { Asset, AssetNewResponse, EthHeaders, ListAssetOptions, PbstPayloadInfo, RawTx, RpcResponse, SyscoinAddressEntry, Transaction, TransactionData, TxHeader, TransactionListEntry, WalletInfo, NetworkInfo, BlockchainInfo, AddressInfo, AssetAllocationAmount, JsonRpcCall } from "./index";
export interface RPCServiceFunctions {
    ...
    quorum_isConflicting(llmqType: number, id: string, msgHash: any, string: any): JsonRpcCall<any>;
    ...
    protx_register(collateralHash: string, collateralIndex: any, number: any, ipAndPort: string, ownerAddress: string, operatorPubKey: string, votingAddress: string, operatorReward: number, payoutAddress: string, fundAddress?: string, submit?: boolean): JsonRpcCall<any>;
    ...
    protx_prepare(collateralHash: string, collateralIndex: any, number: any, ipAndPort: string, ownerAddress: string, operatorPubKey: string, votingAddress: string, operatorReward: number, payoutAddress: string, fundAddress?: string): JsonRpcCall<any>;
