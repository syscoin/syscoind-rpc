...
export function rpcServices(callRpc): RPCServiceFunctions {
  return {
    ...
    assetInfo({assetGuid}) { return callThroughToRpc(arguments) },
    assetNew({address, publicValue, contract, precision, supply, maxSupply, updateFlags, witness}) { return callThroughToRpc(arguments) },
