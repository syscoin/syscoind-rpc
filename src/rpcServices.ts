...
export function rpcServices(callRpc): RPCServiceFunctions {
  return {
    ...
    signRawTransactionWithKey({hexString, privateKeys, txs, sigHashType}): Promise<any> { return callThroughToRpc(arguments) },
    ...
    getNewAddress({label, addressType}): Promise<any> { return callThroughToRpc(arguments) },
    ...
    getTransaction({txid, includeWatchOnly}): Promise<Transaction> { return callThroughToRpc(arguments) },
